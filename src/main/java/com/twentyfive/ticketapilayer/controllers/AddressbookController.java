...
public class AddressbookController {
    ...
    public ResponseEntity<List<AddressBook>> getAll(){
        ...
        //Qua c'era username
        List<AddressBook> result = addressbookController.getAll();
    ...
    public ResponseEntity<AddressBook> getByUsername(){
        //String username = authenticationService.getUsername();
        //Qua c'era username
        AddressBook result = addressbookController.getByUsername();
        return ResponseEntity.ok().body(result);
    }
   ...
   /* @GetMapping("/total-list")
    ...
    public ResponseEntity<Object> getAdressbookList(@RequestBody AddressBookFilter filter,
        ...
        //String username = authenticationService.getUsername();
        //Qua c'era username
        Page<AddressBook> result = addressbookController.getAdressbookList(filter, page, sizeP);
        return ResponseEntity.ok().body(result);
    }
    ...
    public ResponseEntity<Page<AddressBook>> filterEventAutocomplete(@RequestParam("filterObject") String filterObject,
        ...
        Page<AddressBook> result = addressbookController.filterAutocomplete(filterObject, page, size);
